              ...
              child: Stack(
                ...
                children: <Widget>[
                  Positioned(
                    ...
                    child: widget.direction == Axis.horizontal ? Icon(widget.withPlusMinus == false ? Icons.keyboard_arrow_left : Icons.remove, size: 40.0, color: widget.iconsColor): Icon(widget.withPlusMinus == false ? Icons.keyboard_arrow_down : Icons.remove,size: 40.0, color: widget.iconsColor),
                  ),
                  Positioned(
                    right: widget.direction == Axis.horizontal ? 10.0 : null,
                    top: widget.direction == Axis.horizontal ? null : 10.0,
                    child:widget.direction == Axis.horizontal ? Icon(widget.withPlusMinus == false ? Icons.keyboard_arrow_right : Icons.add, size: 40.0, color: widget.iconsColor): Icon(widget.withPlusMinus == false ? Icons.keyboard_arrow_up : Icons.add, size: 40.0, color: widget.iconsColor),
                  ),
                  GestureDetector(
